...
export const metadata = {
  title: "Login || Cooking station",
  description: "this is Login page of Cooking stations",
};
    ...
    <main className="authentications">
      ...
      <div className="right-content order-0">
        <div className="authentic">
          <header className="authenticationheader d-flex justify-content-center mb-3">
            <NavLink href="/" className="logo">
              <Image src={logo} alt="logo" />
            </NavLink>
          </header>
          <h4 className="welcome-title mb-2">Welcome back</h4>

          <p className="welcome-text">Please enter your details to login</p>

          <div className="socialauth">
            <button className="btn-socialauth">
              <FaApple />
            </button>
            <button className="btn-socialauth">
              <FaGoogle />
