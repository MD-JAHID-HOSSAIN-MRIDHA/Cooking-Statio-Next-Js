import { Navigation, Pagination, Swiper, SwiperSlide } from "@/Components/shared/ClientImport";
  ...
  return (
    <>
      ...
      <section className="container hero bg-white">
        ...
        <div
          className="d-lg-flex flex-md-row-reverse justify-content-between align-items-center w-100 gap-5"
        >
          <div className="flex-1 overflow-hidden pt-6">
            ...
            >
              ...
              <div className="swiper-hero-prev text-white">
          ...
          <div className="hero_content flex-1 pt-3">
            <div>
              ...
              <p className="banner_body py-3 text-justify">
                ...
                Delivery For Bachelor, Officials, Family's and also as per needed
                for Events.
              </p>
            </div>
            <div className="hero_action_btn text-center text-lg-start">
              <button className="cs_btn">Subscription</button>
              <button className="live_btn"><span></span></button>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className=" ">
            ...
            <div className="watch_btn_container">
              <button className="watch_btn">
                <Image src={watchVideo} alt="watch video thumbnail" /><span
                >Watch Video</span
                >
              </button>
            </div>
        ...
        <div className="container">
          ...
          <div className="section_body">
            ...
            <div className="step_card">
              <div className="content">
                <figure>
                  <img src="assets/images/icons/fast-delivery.svg" alt="" />
                </figure>
          ...
          <div className="row g-4">
            <div className="col-lg-6">
              <div className="choose-wrapper">
                <div className="singlechoose">
                  <div className="circle">
                    <figure className="chooseusthumb">
                      <img src="assets/images/home/chooseus/1.png" alt="" />
                    </figure>
                  </div>
                  <div className="right">
                ...
                <div className="singlechoose">
                  <div className="circle">
                    <figure className="chooseusthumb">
                      <img src="assets/images/home/chooseus/2.png" alt="" />
                    </figure>
                  </div>
                  <div className="right">
                ...
                <div className="singlechoose">
                  <div className="circle">
                    <figure className="chooseusthumb">
                      <img src="assets/images/home/chooseus/3.png" alt="" />
                    </figure>
                  </div>
                  <div className="right">
                ...
                <div className="singlechoose">
                  <div className="circle">
                    <figure className="chooseusthumb">
                      <img src="assets/images/home/chooseus/4.png" alt="" />
                    </figure>
                  </div>
                  <div className="right">
                ...
                <div className="singlechoose">
                  <div className="circle">
                    <figure className="chooseusthumb">
                      <img src="assets/images/home/chooseus/5.png" alt="" />
                    </figure>
                  </div>
                  <div className="right">
            ...
            <div className="col-lg-6">
              <div className="section-top text-start align-items-start">
                ...
                <p className="des">
                  What makes us Difference to make you choose us!We are prominent
                  to deliver home cooked and original taste food anywhere in the
                  country and we gonna launch worldwide.
                </p>
              </div>
              <div className="image-wrapper">
                <figure>
                  <img src="assets/images/home/chooseus/right1.png" alt="" />
                </figure>
                <figure>
                  <img src="assets/images/home/chooseus/right-2.png" alt="" />
                </figure>
              </div>
            </div>
          </div>
              ...
              <div className="row justify-content-center">
                <div className="col-lg-12">
                  <div className="cardcorporate">
                    <p>
                      Welcome to Cooking Station – where the heart of home-cooked
                      goodness meets the convenience of doorstep delivery! <br />
                      <br />

                      We are passionate food enthusiasts committed to bringing the
                      warmth and flavors of homemade meals right to your table.
                      <br />
                      <br />
                    ...
                    <h3 className="price">BDT 120/ <span>per meal</span></h3>
                    <a href="/pakages" className="cs_btn">Subscription </a>
                    <span className="or">OR</span>
                    <a href="/pakages" className="cs_btn">Customize Your Own Plan </a>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="row">
            <div className="col-lg-6">
              <figure className="testimonialthumb">
                <img
                  src="assets/images/home/testimonial-left.png"
                    ...
                    <div className="swiper-slide">
                      ...
                      <div className="single-testimonial">
                        ...
                        <p className="text">
                          ...
                          quality of the food was outstanding. It truly felt like
                          a home-cooked meal made with love. We'll be spreading
                          the word about this gem!
                        </p>
                        <div className="profile-info">
                          <figure className="testimonial-thumb">
                            <img
                    ...
                    <div className="swiper-slide">
                      ...
                      <div className="single-testimonial">
                        ...
                        <p className="text">
                          ...
                          experience! The food was top-notch, and the presentation
                          was impeccable. It added that extra touch of
                          sophistication to our event. We'll definitely be coming
                          back for more!
                        </p>
                        <div className="profile-info">
                          <figure className="testimonial-thumb">
          ...
          <div className="row g-4">
            ...
            <div className="col-12 col-lg-4">
              <figure className="eventimg">
                <img src="assets/images/event/event-bg.png" alt="" />
              </figure>
            </div>
            <div className="col-12 col-lg-4">
              <div className="eventbox">
      ...
      <section className="ourchefs position-relative">
        <div className="container">
          <div className="section-top">
            ...
            <p className="des">
              Treat yourself to our talented chefs' homemade delights. <br />
              ...
              <div className="swiper-slide">
                <div className="chefcard">
                  ...
                  <div className="content">
                    ...
                    <p className="des">
                      An idol house wife, who live in Mirpur DOHS, Dhaka 1206. Her
                      cooking hand is very well and you will love it we swear.
                    </p>
                  </div>
                </div>
              </div>
              <div className="swiper-slide">
                <div className="chefcard">
                  ...
                  <div className="content">
                    ...
                    <p className="des">
                      He is an experienced cook. He has given service in Hotel for
                      8 years. Now he is serving meal to office worker and family.
                      His workplace is Mirpur 2, Comm erce College Road, Dhaka
                      1216
                    </p>
                  </div>
                </div>
        ...
        <div className="support_section collapse" id="collapseExample">
          ...
          <div className="support_body">
            <form className="row contact_form">
              ...
              <div className="col-12">
                <button type="submit" className="cs_btn w-100">Continue</button>
              </div>
            </form>
          ...
          <div className="support_footer">
            ...
            <div className="icon_container">
              <div>
                <a href="">
                  <img src="assets/icons/whatsup.png" alt="" />
                </a>
              </div>
              <div>
                <a href="">
              ...
              <div>
                <a href="">
                  <img src="assets/icons/phone.jpg" alt="" />
                </a>
              </div>
            </div>
          </div>
