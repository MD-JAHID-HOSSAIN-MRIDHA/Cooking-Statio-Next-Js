                ...
                <div className="col-lg-6">
                  <div className="blog-card">
                    <figure className="blog-thumb">
                      <Image src={blog1} alt="Blog thumbnail" />
                    </figure>
              ...
              <div className="right-content ps-lg-5">
                ...
                <div className="recent-blog">
                  ...
                  <div className="blog-posts">
                    ...
                    <a href="#" className="blog-post">
                      <figure>
                        <Image src={blog3} alt="Blog thumbnail" />
                      </figure>
                      <div className="right">
                        <h3 className="title">Health & Nutrition</h3>
                        <p className="date">
                ...
                <div className="recent-blog">
                  ...
                  <div className="blog-posts">
                    <a href="#" className="blog-post">
                      <figure>
                        <Image src={blog4} alt="Blog thumbnail" />
                      </figure>
                      <div className="right">
                        <h3 className="title">Health & Nutrition</h3>
                      </div>
                    ...
                    <a href="#" className="blog-post">
                      <figure>
                        <Image src={blog5} alt="Blog thumbnail" />
                      </figure>
                      <div className="right">
                        <h3 className="title">Health & Nutrition</h3>
                      </div>
                    ...
                    <a href="#" className="blog-post">
                      <figure>
                        <Image src={blog6} alt="Blog thumbnail" />
                      </figure>
                      <div className="right">
                        <h3 className="title">Health & Nutrition</h3>
                      </div>
